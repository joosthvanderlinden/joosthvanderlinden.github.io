...
- My PhD research. Apparently, people like it, because I received a best-presention award at our annual postgrad conference. I believe there is a lot of potential for the use of machine learning in engineering physics.
...
- <div onClick="openClose_skill('p1')" style="cursor:hand; cursor:pointer">Python</div><div id="p1" class="texter">
...
- <div onClick="openClose_skill('p2')" style="cursor:hand; cursor:pointer">C++</div><div id="p2" class="texter">
...
- <div onClick="openClose_skill('p3')" style="cursor:hand; cursor:pointer">Matlab</div><div id="p3" class="texter">
...
- <div onClick="openClose_skill('p4')" style="cursor:hand; cursor:pointer">VBA</div><div id="p4" class="texter">
...
- <div onClick="openClose_skill('p5')" style="cursor:hand; cursor:pointer">Other</div><div id="p5" class="texter">
  Java: undergraduate subject. HTML/Jekyll: this website. Unix: bash, compilation. Photoshop, iMovie: image/video editing.
<br /><br /></div>
